...
public class PedidoCarrito {
	...
	public void setNumero_tarjeta_credito(String numero_tarjeta_credito) {
	...
	public void setFecha_caducidad_tarjeta(LocalDate fecha_caducidad_tarjeta) {
	...
	public void setCcv_tarjeta_credito(int ccv_tarjeta_credito) {
